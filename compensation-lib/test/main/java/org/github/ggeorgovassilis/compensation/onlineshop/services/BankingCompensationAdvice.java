...
public class BankingCompensationAdvice implements IBankService,
	...
	public BankAccountReport addAmount(int accountNumber, int amount) {
		...
		cm.registerOperation(new BankOperation(accountNumber, amount, target,
				this, OPCODE.modify), cm.getActiveTransaction());
		return report;
	}
	...
	public BankAccountReport createBankAccount(int accountNumber) {
		...
		cm.registerOperation(
				new BankOperation(accountNumber, report.getBalance(), target,
						this, OPCODE.create), cm.getActiveTransaction());
		return report;
	}
	...
	public BankAccountReport deleteBankAccount(int accountNumber) {
		...
		cm.registerOperation(
				new BankOperation(accountNumber, report.getBalance(), target,
						this, OPCODE.delete), cm.getActiveTransaction());
		return report;
	}
