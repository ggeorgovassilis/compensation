...
public class BankOperation extends Operation{
    ...
    public enum OPCODE{modify,create,delete};
    private final int accountNumber;
    private final int amount;
    private final IBankService service;
    private final OPCODE opcode;
    
    public BankOperation(int accountNumber, int amount, IBankService service, BankingCompensationAdvice advice, OPCODE opcode) {
	super(advice);
